...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/ANT.AMAZON.COM/kgnanask/sandbox/nitro-starter/.data/kv"}));
...
const _lazy_KtqoSg = () => import('./chunks/index.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/', handler: _lazy_KtqoSg, lazy: true, middleware: false, method: undefined }
];
...
export { defineEventHandler as d };
