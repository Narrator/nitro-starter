...
import { resolve, dirname, relative, normalize, isAbsolute, join, extname as extname$1, basename as basename$1 } from 'pathe';
...
import { n as nitroPkg, v as version } from './nitro.9085b632.mjs';
import _replace from '@rollup/plugin-replace';
import { createHash } from 'node:crypto';
import { extname, basename, resolve as resolve$1 } from 'node:path';
  ...
  hooks: {
    ...
    "rollup:before": (nitro, rollupConfig) => {
      ...
      rollupConfig.plugins.unshift({
        name: "nitro:firebase",
        transform: (code, id) => {
          if (basename$1(id).startsWith("firebase-gen-")) {
            return {
              code: code.replace(
